# Mirakurun/Mirakc API Streaming Endpoint Usage by EPGStation

This document outlines how EPGStation interacts with Mirakurun's (and Mirakc's) REST API for live TV viewing and recording.

## 1. Live TV Viewing
**Endpoint:** [`GET /api/services/{id}/stream`](https://github.com/mirakc/mirakc/blob/main/docs/web-api.md#get-apiservicesidstream)
...
**Endpoint:** [`GET /api/programs/{id}/stream`](https://github.com/mirakc/mirakc/blob/main/docs/web-api.md#get-apiprogramsidstream)
...
Currently, the endpoint [`GET /api/channels/{channel_type}/{channel}/stream`](https://github.com/mirakc/mirakc/blob/main/docs/web-api.md#get-apichannelschannel_typechannelstream) is **not** used for primary recording or live streaming operations in EPGStation; it relies on the Service ID (`/api/services/...`) instead to target specific sub-channels accurately.
